...
class __TwigTemplate_d50610d71fd874585228b154aa1a29a5 extends Template
{
    ...
    <ul class=\"pager__items js-pager__items\">
      ";
            // line 17
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "previous", [], "any", false, false, true, 17)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 18
      ...
      ";
          ...
          ";
                // line 27
                yield t("Page @items.current", ["@items.current" => CoreExtension::getAttribute($this->env, $this->source,                 // line 28
($context["items"] ?? null), "current", [], "any", false, false, true, 28), ]);
      ...
      ";
            ...
            // line 32
            yield "      ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 32)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 33
